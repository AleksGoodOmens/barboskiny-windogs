import { appendTo, appendToObj, createElement, putTextContent } from "../builders/_builders.js";
	...
	function createInstallWindow() {
		...
		installBtn.addEventListener("click", () => {
			...
			btnNext.addEventListener("click", () => {
				...
				appendTo(".setup__content", createElement("setup__footer"));
				appendTo(".setup__footer", createElement("setup__checkBox-label", "label"));
				appendTo(".setup__checkBox-label", createElement("setup__checkBox", "input"));
				let input = document.querySelector("input");
				input.setAttribute("type", "checkbox");
				appendTo(".setup__checkBox-label", createElement("setup__label", "span"));
...
const breadDots = ["Next Setup", "install Windogs"];

const selectOptionsLanguage = ["English(UK)", "English(US)", "Russian(RU)"];
